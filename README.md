...
* **(Feb 07, 11:59 pm ET) Finalize deliverables:** Finalize project deliverables after regular back-and-forth discussions with the instructors (you should have these conversations during OH, via slack, or schedule a separate time). You should have received approval from the instructors before submitting your deliverables document (so plan accordingly). Email the instructors with your group's project deliverables document, describing what you will tentatively achieve for milestone 1, milestone 2, and the final report (<=1 page). Your document will answer the following questions: (1) What is the specific goal of your project? (2) What will you (tentatively) achieve in each of the milestones?
* **(Feb 28, 11:59 pm ET) First milestone:** Submit your first milestone document that defines and motivates the problem, surveys related work, forms an initial hypothesis and idea, and includes some preliminary result to show that the idea is promising (email instructors). This document should be less than 5 pages (not including references).
*  **(Apr 01, 11:59 pm ET) Second milestone:** Submit your second milestone document with a brief description of the idea, your design and implementation details, and a portion of your evaluation (email instructors). This document should be less than 10 pages (not including references).
...
| Jan 24 (W) | **Fall's Holiday Slot** |  | |
| Jan 29 (M) | [An Open-Source Benchmark Suite for Microservices and Their Hardware-Software Implications for Cloud and Edge Systems](http://www.csl.cornell.edu/~delimitrou/papers/2019.asplos.microservices.pdf) | Web application paradigms | - Submit project proposal document describing project topic (<=1 page) on Sep 8 </br> -[Supplemental reading](https://www.nginx.com/blog/introduction-to-microservices/) | Student TBD | Student TBD | Student TBD |
| Jan 31 (W) | [Profiling a Warehouse-Scale Computer](https://static.googleusercontent.com/media/research.google.com/en//pubs/archive/44271.pdf) | Microarchitecture analysis | | Student TBD | Student TBD | Student TBD |
| Feb 05 (M) | [SoftSKU: Optimizing Server Architectures for Microservice Diversity @Scale](https://dl.acm.org/doi/10.1145/3307650.3322227) | Microarchitecture analysis | -[Supplemental reading](http://csl.stanford.edu/~christos/publications/2018.search.hpca.pdf) | Student TBD | Student TBD | Student TBD |
| Feb 07 (W) | [A Reconfigurable Fabric for Accelerating Large-Scale Datacenter Services](http://dl.acm.org/citation.cfm?id=2665678)| Hardware acceleration | - [Supplemental reading](https://www.csl.cornell.edu/~delimitrou/papers/2021.asplos.dagger.pdf)|  Student TBD | Student TBD | Student TBD |
| Feb 12 (M) | **No Class** | - Submit project deliverables document (<=1 page) </br> | |
| Feb 14 (W) | [A hardware accelerator for protocol buffers](https://sagark.org/assets/pubs/protoacc-micro2021-preprint.pdf) | Hardware acceleration | Guest: [Sagar Karandikar (UC Berkeley)](https://sagark.org/) </br> - [Supplemental reading 1](https://www.gwern.net/docs/cs/2021-ranganathan.pdf) </br> [Supplemental reading 2](https://michaeltaylor.org/papers/ASIC_Cloud_ISCA_2016_Proceedings.pdf) |  Student TBD | Student TBD | Student TBD |
| Feb 19 (M) | [AsmDB: Understanding and Mitigating Front-End Stalls in Warehouse-Scale Computers](https://dl.acm.org/doi/pdf/10.1145/3307650.3322234) | Compiler/PGO | - [Supplemental reading](https://dl.acm.org/doi/pdf/10.1145/3466752.3480124) | Student TBD | Student TBD | Student TBD |
| Feb 21 (W) | -[The Tail at Scale](https://cacm.acm.org/magazines/2013/2/160173-the-tail-at-scale/fulltext) </br> -[Attack of the Killer Microseconds](https://abelay.github.io/6828seminar/papers/barroso:killermicroseconds.pdf)| Tail latency, Killer microseconds | [Supplemental reading](https://docs.wixstatic.com/ugd/66fd54_b1a7b4d81fee4750a8cfd19107c8f55a.pdf) | Student TBD | Student TBD | Student TBD |
| Feb 26 (M) | [The Demikernel Datapath OS Architecture for Microsecond-scale Datacenter Systems](https://irenezhang.net/papers/demikernel-sosp21.pdf) | OS | - Guest: [Thomas Wenisch](https://scholar.google.com/citations?user=MJ5G4xgAAAAJ&hl=en) (Google) </br> - [Supplemental reading](https://www.usenix.org/system/files/conference/osdi14/osdi14-paper-belay.pdf) | Student TBD | Student TBD | Student TBD |
| Feb 28 (W) | [Dynamo: facebook's data center-wide power management system](https://ieeexplore.ieee.org/document/7551415)| Power/energy | - Guest: [Justin Meza](http://justinmeza.com/) </br> - First project milestone due (<5 pages)  | Student TBD | Student TBD | Student TBD |
| Mar 04 (M) | **Spring break: No Class** |  | |
| Mar 06 (W) | **Spring break: No Class** |  | |
| Mar 11 (M) | [Resource Central: Understanding and Predicting Workloads for Improved Resource Management in Large Cloud Platforms](https://www.microsoft.com/en-us/research/wp-content/uploads/2017/10/Resource-Central-SOSP17.pdf) | Resource management/scheduling | - [Supplemental reading](http://research.google.com/pubs/pub43438.html) | Student TBD | Student TBD | Student TBD |
| Mar 13 (W) | [Serverless in the Wild: Characterizing and Optimizing the Serverless Workload at a Large Cloud Provider](https://www.microsoft.com/en-us/research/uploads/prod/2020/05/serverless-ATC20.pdf) | Serverless computing | - Guest: [Mohammad Shahrad](https://mshahrad.github.io/) (UBC) </br> - [Supplemental reading](https://www.cs.utexas.edu/users/witchel/pubs/jia21asplos-nightcore.pdf) | Student TBD | Student TBD | Student TBD |
| Mar 18 (M) | [Cost-Efﬁcient Overclocking in Immersion-Cooled Datacenters](https://www.microsoft.com/en-us/research/publication/cost-ef%ef%ac%81cient-overclocking-in-immersion-cooled-datacenters/) | DC cooling | | Student TBD | Student TBD | Student TBD |
| Mar 20 (W) | [Chasing Carbon: The Elusive Environmental Footprint of Computing](https://arxiv.org/pdf/2011.02839.pdf) | Sustainability |  |  Student TBD | Student TBD | Student TBD |
| Mar 25 (M) | [ACT: Designing Sustainable Computer Systems With An Architectural Carbon Modeling Tool](https://ugupta.com/files/Gupta_ISCA2022_ACT.pdf) | Sustainability | - [Supplemental reading](https://hotcarbon.org/2023/pdf/a7-lyu.pdf) </br> | Student TBD | Student TBD | Student TBD |
| Mar 27 (W) | - [Nines are not enough](https://storage.googleapis.com/pub-tools-public-publication-data/pdf/f647d24ee7eeb338acebf1eb73a5d11b357620b0.pdf) | DC business model | | Student TBD | Student TBD | Student TBD |
