...
The course is a combination of paper reading and reviewing, in-class presentations, paper disucssions, and a semester-long project. Students will read up to two seminal papers per topic and submit brief summaries via [hotcrp](https://cmu-18-847-s24.hotcrp.com/). In the classroom, we will have a student presentation of the papers accompanied by an interactive discussion on the papers in terms of design innovation and challenges. From time to time, we will have guest speakers who are typically the authors of the paper being discussed. Students will work in groups of three on a semester-long, open-ended research project on a cutting-edge data center topic.
...
* **(30%) Paper Reviews:** We will be writing reviews for the papers that we read in this course. These reviews will help practice critical examination of research papers related to data center computing. Each student can skip a total of three reviews across the semester (choose wisely!). Each miss beyond three will result in 25% decrease in grade for this portion of the course. Reviews will be submitted through [hotCRP](https://cmu-18-847-s24.hotcrp.com/). We will discuss the guidelines for writing reviews during the first couple of lectures.
...
* All paper reviews will be submitted via [hotcrp](https://cmu-18-847-s24.hotcrp.com/) (Create an account ASAP!)
...
* All presentations will be accessible via a single google slides [link](https://docs.google.com/presentation/d/1byi14KJc1AI2yY1LIwRGgIWgjbsNDRtr_hQLEoDjAEA/edit?usp=sharing).
...
* **(Jan 22/ASAP) Find project partners:** Create a group of three like-minded students (e.g., does everyone in your group want to work on a software solution?) Please feel free to use the "project-groups" Slack channel to find your project peeps.
...
* **(Feb 26, 11:59 pm ET) First milestone:** Submit your first milestone document that defines and motivates the problem, surveys related work, forms an initial hypothesis and idea, and includes some preliminary result to show that the idea is promising (email instructors). This document should be less than 5 pages (not including references).
*  **(Mar 25, 11:59 pm ET) Second milestone:** Submit your second milestone document with a brief description of the idea, your design and implementation details, and a portion of your evaluation (email instructors). This document should be less than 7 pages (not including references).
*  **(Apr 24, 11:59 pm ET) Final presentation:** Prepare a brief presentation (~10 minutes) of your project work and present it with your group. Divide your presentation such that each person presents for an equal amount of time. Each member must participate in answering questions on the project. 
*  **(Apr 26, 11:59 pm ET) Final report:** Submit a final paper on your work that is similar to the papers that we read and discussed in class. This document should be less than 10 pages (not including references).
...
### Schedule
Please submit a review for each paper on [hotcrp](https://cmu-18-847-s24.hotcrp.com/) by 9 am ET on the day of the class. Here is the review [template](https://gist.github.com/kasikci/49e7107dfdee281d6f6450b132555550) we will use.
...
| Jan 29 (M) | [Profiling a Warehouse-Scale Computer](https://static.googleusercontent.com/media/research.google.com/en//pubs/archive/44271.pdf) | Microarchitecture analysis | - Submit project proposal document describing project topic (<=1 page) </br> | Hung-Chieh (Tommy) Chen | Eugene Min | Swamynathan |
...
| Feb 05 (M) | [A Reconfigurable Fabric for Accelerating Large-Scale Datacenter Services](http://dl.acm.org/citation.cfm?id=2665678)| Hardware acceleration | - Submit project deliverables document (<=1 page) </br> - [Supplemental reading](https://www.csl.cornell.edu/~delimitrou/papers/2021.asplos.dagger.pdf)|  Quanchen Ding | Alison Jin | William Krska  |
| Feb 07 (W) | [A hardware accelerator for protocol buffers](https://sagark.org/assets/pubs/protoacc-micro2021-preprint.pdf) | Hardware acceleration | - [Supplemental reading 1](https://www.gwern.net/docs/cs/2021-ranganathan.pdf) </br> [Supplemental reading 2](https://michaeltaylor.org/papers/ASIC_Cloud_ISCA_2016_Proceedings.pdf) |  Sanjana Shriram | Hung-Chieh (Tommy) Chen | Rohan Sonecha |
| Feb 12 (M) | [AsmDB: Understanding and Mitigating Front-End Stalls in Warehouse-Scale Computers](https://dl.acm.org/doi/pdf/10.1145/3307650.3322234) | Compiler/PGO | - [Supplemental reading](https://dl.acm.org/doi/pdf/10.1145/3466752.3480124) | Sirui Qi | Disha Hegde |	Humza Ikram |
| Feb 14 (W) | -[The Tail at Scale](https://cacm.acm.org/magazines/2013/2/160173-the-tail-at-scale/fulltext) </br> -[Attack of the Killer Microseconds](https://abelay.github.io/6828seminar/papers/barroso:killermicroseconds.pdf)| Tail latency, Killer microseconds | [Supplemental reading](https://docs.wixstatic.com/ugd/66fd54_b1a7b4d81fee4750a8cfd19107c8f55a.pdf) | Hung-Chieh (Tommy) Chen | Yuxin Deng | Eugene Min |
| Feb 19 (M) | [The Demikernel Datapath OS Architecture for Microsecond-scale Datacenter Systems](https://irenezhang.net/papers/demikernel-sosp21.pdf) | OS | - [Supplemental reading](https://www.usenix.org/system/files/conference/osdi14/osdi14-paper-belay.pdf) | Alison Jin | Sanjana Shriram | Aayush Gupta |
| Feb 21 (W) | [Dynamo: facebook's data center-wide power management system](https://ieeexplore.ieee.org/document/7551415)| Power/energy | - First project milestone due (<=5 pages)  | Isabella Siu | Xinshi Wang | Yuxin Deng |
| Feb 26 (M) | [Resource Central: Understanding and Predicting Workloads for Improved Resource Management in Large Cloud Platforms](https://www.microsoft.com/en-us/research/wp-content/uploads/2017/10/Resource-Central-SOSP17.pdf) | Resource management/scheduling | - Guest: [Íñigo Goiri]
(https://www.microsoft.com/en-us/research/people/inigog/) (Microsoft Research) - [Supplemental reading](http://research.google.com/pubs/pub43438.html) | Swamynathan | Hanlu Xu | Quanchen Ding |
| Feb 28 (W) | **No Class** |  | |
| Mar 04 (M) | **Spring break: No Class** |  | |
| Mar 06 (W) | **Spring break: No Class** |  | |
| Mar 11 (M) | [Serverless in the Wild: Characterizing and Optimizing the Serverless Workload at a Large Cloud Provider](https://www.microsoft.com/en-us/research/uploads/prod/2020/05/serverless-ATC20.pdf) | Serverless computing | - [Supplemental reading](https://www.cs.utexas.edu/users/witchel/pubs/jia21asplos-nightcore.pdf) | Rohan Sonecha | Sirui Qi | Michael Chen |
| Mar 13 (W) | [Cost-Efﬁcient Overclocking in Immersion-Cooled Datacenters](https://www.microsoft.com/en-us/research/publication/cost-ef%ef%ac%81cient-overclocking-in-immersion-cooled-datacenters/) | DC cooling | | Eugene Min | Isabella Siu | Disha Hegde |
| Mar 18 (M) | [Chasing Carbon: The Elusive Environmental Footprint of Computing](https://arxiv.org/pdf/2011.02839.pdf) | Sustainability |  |  Humza Ikram | Aayush Gupta | Sanjana Shriram |
| Mar 20 (W) | [ACT: Designing Sustainable Computer Systems With An Architectural Carbon Modeling Tool](https://ugupta.com/files/Gupta_ISCA2022_ACT.pdf) | Sustainability | - [Supplemental reading](https://hotcarbon.org/2023/pdf/a7-lyu.pdf) </br> | William Krska | Rohan Sonecha | Alison Jin |
| Mar 25 (M) | - [Nines are not enough](https://storage.googleapis.com/pub-tools-public-publication-data/pdf/f647d24ee7eeb338acebf1eb73a5d11b357620b0.pdf) | DC business model | - Second project milestone due (<=7 pages) <br/> | Sanjana Shriram | Isabella Siu | Sirui Qi |
| Mar 27 (W) | No paper review | Ethics |  |  | |  |
| Apr 01 (M) | **No Class** |  | |
| Apr 03 (W) | [Software-defined far memory in warehouse-scale computers](https://storage.googleapis.com/pub-tools-public-publication-data/pdf/9bb06ab825a127bef4e33c488eaa659d6856225a.pdf) | ML for datacenter systems | - [Supplemental reading](https://www.microsoft.com/en-us/research/uploads/prod/2020/01/CACM20-produced.pdf) | Yuxin Deng | Swamynathan | Xinshi Wang |
| Apr 08 (M) | [Bolt: I Know What You Did Last Summer... in the Cloud](https://www.csl.cornell.edu/~delimitrou/papers/2017.asplos.bolt) | Security | [Supplemental reading](https://hovav.net/ucsd/dist/cloudsec.pdf)  | Hanlu Xu | William Krska  | Hung-Chieh (Tommy) Chen |
| Apr 10 (W) | [Cores that don't count](https://storage.googleapis.com/pub-tools-public-publication-data/pdf/012b01a2571a6e226259cd0c4628eb3015157d44.pdf) | Reliability |  | Michael Chen | Quanchen Ding | Eugene Min |
| Apr 15 (M) | **No Class** |  | |
| Apr 17 (W) | **No Class** |  | |  
